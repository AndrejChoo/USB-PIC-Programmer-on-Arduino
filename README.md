...
Добавил поддержку PIC18F66K22

# 18.03.2026

Переписал проект под Arduino IDE, теперь можно прошивать плату Arduino без всяких дополнительных программ просто, как обычный скетч. Скетч будет работать только на платах avr с atmega168/atmega328 с кварцем на 16 MHz, так как он написан на Си, а не Wiring.
